...
activities = {
    ...
    "Swim Club": {
        "description": "Swimming practice and water safety skills",
    ...
    "Music Ensemble": {
        "description": "Instrumental practice and ensemble performances",
    ...
    "Debate Team": {
        "description": "Public speaking and argumentation practice for competitions",
